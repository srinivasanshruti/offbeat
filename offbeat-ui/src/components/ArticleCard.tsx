            ...
            <div className="absolute inset-0">
              <a href={ link } target="_blank" onClick={ () => addToRecent(id) }>
                ...
                <div className="px-6 py-4 left-0 bottom-0">
                  ...
                  <p className="text-gunmetal text-xs pb-2 md:text-sm">
            ...
            <div
              ...
              <a href={ link } target="_blank" onClick={ () => addToRecent(id) }>
                <div className="flex h-full flex-col">
                  <h1 className="text-2xl font-bold mt-5 mb-4 line-clamp-4">{ title }</h1><h3 className="text-lg line-clamp-10">{ description }</h3>
                </div>
              </a>
            </div>
          </div>
